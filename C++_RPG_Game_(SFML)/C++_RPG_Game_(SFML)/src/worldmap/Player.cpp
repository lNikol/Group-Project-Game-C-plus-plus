...
RPG::Player::Player(float startX, float startY) : position(startX, startY) {}

sf::Vector2f RPG::Player::getPosition() const { return position; }

sf::Vector2f RPG::Player::getInputDirection() const {
...
void RPG::Player::update(float deltaTime, const WorldMap& worldMap) {
...
void RPG::Player::draw(sf::RenderWindow& window, const SpritesheetManager& sm) {
